...
{   
  ...
  { 
    ...
    folder.iconImg.src = classPath+"/"+ftv2folderopen
  ...
  { 
    ...
    folder.iconImg.src = classPath+"/"+ftv2folderclosed 
    for (i=0; i<folder.nChildren; i++) 
...
{ 
  if (browserVersion == 2) { 
    ...
    if (!doc.yPos) 
      doc.yPos=200 
    doc.write("<layer id='folder" + this.id + "' top=" + doc.yPos + " left=" + doc.xPos + " visibility=hiden>") 
  } 
...
{ 
  if (this.hreference) 
  { 
    doc.write("<a href='" + this.hreference + "' TARGET='_blank' ") 
    if (browserVersion > 0) 
...
{ 
  ...
  this.iconSrc = classPath+"/"+ftv2doc 
